...
%% with new filenames distinct from pprthree.tex.
%% 
...
\nomenclature[gd]{$\delta$}{thermocline thickness, a variable definition
  with a really long description to verify formatting}%
\nomenclature[si]{$i$}{inlet}%
defined previously by \citep{winkle.1991} and
\citet{bullwinkle.1990}. \lipsum[57-60]
